        ...
        [
            {
                ...
                data:
                    [
                        ...
                        ['gl',  'rv',  'gul', 'gu',  'gur', 'rv',   'gdl', 'gld', 'gr',  'rv',  'glr',  'rv',   'gudl', 'gurd', 'rv',   'gurdl', 'gr'],
                        ['gl',  'rv',  'gl',  'gdr', 'grd', 'rtr',  'rur', 'gl',  'gr',  'rv',  'glr',  'rtr',  'rh',   'rh',   'rtu',  'rur',   'gr'],
                        ['gl',  'rv',  'gdl', 'grd', 'rul', 'rrd',  'rv',  'gdl', 'grd', 'rv',  'glr',  'rv',   'gudl', 'gud',  'gurd', 'rv',    'gr'],
